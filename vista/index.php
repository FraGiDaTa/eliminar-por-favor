...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="../plantilla/../plantilla/bower_components/bootstrap/dist/css/bootstrap.min.css">
  <!-- Font Awesome -->
...
<div class="card card-warning">
    <div class="card-header">
        <h3 class="card-title">Bienvenidos al contenido Principal</h3>
